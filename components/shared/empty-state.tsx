...
const illustrations = {
  vault: (
    <svg width="120" height="100" viewBox="0 0 120 100" fill="none" className="mb-6">
      <rect x="20" y="25" width="80" height="65" rx="8" stroke="black" strokeWidth="1.5" fill="none" />
  ...
  general: (
    <svg width="120" height="100" viewBox="0 0 120 100" fill="none" className="mb-6">
      <rect x="20" y="15" width="80" height="70" rx="8" stroke="black" strokeWidth="1.5" fill="black" fillOpacity={0.04} />
