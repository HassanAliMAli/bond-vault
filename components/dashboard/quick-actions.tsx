...
const actions = [
  { href: "/bonds/add", label: "Add Bond", description: "Store a new prize bond", icon: PlusCircle, accent: "bg-gold/10 text-gold", primary: true },
  { href: "/check", label: "Check Bonds", description: "Match against draws", icon: SearchCheck, accent: "bg-green/10 text-green" },
  { href: "/bonds", label: "Manage Bonds", description: "View and organize", icon: ScrollText, accent: "bg-dark-700 text-white" },
  { href: "/settings", label: "Settings", description: "Account preferences", icon: Settings, accent: "bg-dark-700 text-white" },
];
